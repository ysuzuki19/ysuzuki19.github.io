...
`,init:t=>{w.setConf(t.journey),y.clear()}}},3463:function(t,e,i){i.d(e,{a:function(){return drawBackgroundRect},b:function(){return drawEmbeddedImage},c:function(){return drawImage},d:function(){return drawRect},e:function(){return getTextObj},f:function(){return drawText},g:function(){return getNoteRect}});var r=i(7967),a=i(8661);let drawRect=(t,e)=>{let i=t.append("rect");if(i.attr("x",e.x),i.attr("y",e.y),i.attr("fill",e.fill),i.attr("stroke",e.stroke),i.attr("width",e.width),i.attr("height",e.height),void 0!==e.rx&&i.attr("rx",e.rx),void 0!==e.ry&&i.attr("ry",e.ry),void 0!==e.attrs)for(let t in e.attrs)i.attr(t,e.attrs[t]);return void 0!==e.class&&i.attr("class",e.class),i},drawBackgroundRect=(t,e)=>{let i={x:e.startx,y:e.starty,width:e.stopx-e.startx,height:e.stopy-e.starty,fill:e.fill,stroke:e.stroke,class:"rect"},r=drawRect(t,i);r.lower()},drawText=(t,e)=>{let i=e.text.replace(a.H," "),r=t.append("text");r.attr("x",e.x),r.attr("y",e.y),r.attr("class","legend"),r.style("text-anchor",e.anchor),void 0!==e.class&&r.attr("class",e.class);let s=r.append("tspan");return s.attr("x",e.x+2*e.textMargin),s.text(i),r},drawImage=(t,e,i,a)=>{let s=t.append("image");s.attr("x",e),s.attr("y",i);let n=(0,r.Nm)(a);s.attr("xlink:href",n)},drawEmbeddedImage=(t,e,i,a)=>{let s=t.append("use");s.attr("x",e),s.attr("y",i);let n=(0,r.Nm)(a);s.attr("xlink:href",`#${n}`)},getNoteRect=()=>({x:0,y:0,width:100,height:100,fill:"#EDF2AE",stroke:"#666",anchor:"start",rx:0,ry:0}),getTextObj=()=>({x:0,y:0,width:100,height:100,"text-anchor":"start",style:"#666",textMargin:0,rx:0,ry:0,tspan:!0})}}]);