...
`,init:t=>{S.setConf(t.journey),p.clear()}}},66893:function(t,e,i){i.d(e,{a:function(){return a},b:function(){return c},c:function(){return o},d:function(){return s},e:function(){return u},f:function(){return l},g:function(){return h}});var r=i(17967),n=i(65009);let s=(t,e)=>{let i=t.append("rect");if(i.attr("x",e.x),i.attr("y",e.y),i.attr("fill",e.fill),i.attr("stroke",e.stroke),i.attr("width",e.width),i.attr("height",e.height),void 0!==e.rx&&i.attr("rx",e.rx),void 0!==e.ry&&i.attr("ry",e.ry),void 0!==e.attrs)for(let t in e.attrs)i.attr(t,e.attrs[t]);return void 0!==e.class&&i.attr("class",e.class),i},a=(t,e)=>{s(t,{x:e.startx,y:e.starty,width:e.stopx-e.startx,height:e.stopy-e.starty,fill:e.fill,stroke:e.stroke,class:"rect"}).lower()},l=(t,e)=>{let i=e.text.replace(n.G," "),r=t.append("text");r.attr("x",e.x),r.attr("y",e.y),r.attr("class","legend"),r.style("text-anchor",e.anchor),void 0!==e.class&&r.attr("class",e.class);let s=r.append("tspan");return s.attr("x",e.x+2*e.textMargin),s.text(i),r},o=(t,e,i,n)=>{let s=t.append("image");s.attr("x",e),s.attr("y",i);let a=(0,r.Nm)(n);s.attr("xlink:href",a)},c=(t,e,i,n)=>{let s=t.append("use");s.attr("x",e),s.attr("y",i);let a=(0,r.Nm)(n);s.attr("xlink:href",`#${a}`)},h=()=>({x:0,y:0,width:100,height:100,fill:"#EDF2AE",stroke:"#666",anchor:"start",rx:0,ry:0}),u=()=>({x:0,y:0,width:100,height:100,"text-anchor":"start",style:"#666",textMargin:0,rx:0,ry:0,tspan:!0})}}]);